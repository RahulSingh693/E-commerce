...
const HomeCards = ({index, image, title, brand}) => {
  return (
    <div key={index} className="cursor-pointer flex flex-col items-center rounded-sm overflow-hidden mx-5 mb-2 shadow-md shadow-slate-100 w-[15rem] bg-white">
      ...
      <div className="flex flex-col items-left p-4 w-[95%]">
        <h1 className="text-lg font-medium text-gray-900">{brand}</h1>
